...
public class Task2 {
    ...
    public static ArrayList<String> getWordByStartWith(String startWithLetter, String[] words) {
        ArrayList<String> result = new ArrayList<String>();
        for (int i = 0; i < words.length; i++) {
            if (words[i].startsWith(startWithLetter)) {
                result.add(words[i]);
            }
        }
        return result;
    ...
    public static ArrayList<String> getWordByEndWith(String endWithLetter, String[] words) {
        ArrayList<String> result = new ArrayList<String>();
        for (int i = 0; i < words.length; i++) {
            if (words[i].endsWith(endWithLetter)) {
                result.add(words[i]);
            }
        }
        return result;
        ...
        while (true) {
            ...
            switch (number) {
                ...
                case 2:
                    ...
                    ArrayList<String> resultStartWith = getWordByStartWith(letter, splitResult);
                ...
                case 3:
                    ...
                    ArrayList<String> resultEndWith = getWordByEndWith(letterEndWith, splitResult);
